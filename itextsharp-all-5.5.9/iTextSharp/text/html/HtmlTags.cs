...
namespace iTextSharp.text.html {
    ...
    public static class HtmlTags {
       ...
       public const String REPEATHEADER = "repeatheader";
            public const String SPLITROW = "splitrow";
            public const String SPLITLATE = "splitlate";
	    /**
	     * name of an attribute
	     * @since 5.0.6
	     */
       ...
       public const String PADDINGBUTTOM = "padding-buttom";
	    public const String PADDINGLEFT = "padding-left";
       public const String PADDINGRIGHT = "padding-right";
       public const String ROWPADDING = "rowpadding";
       public const String USEASCENDER = "useascender";
	    /**
	     * The CSS tag for the font size.
	     * @since 5.0.6
	     */

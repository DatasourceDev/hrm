   ...
   public class SubscriptionController : ControllerBase
   {
      ...
      public ActionResult DetailSignUp(SignUpViewModel model)
      {
          ...
          if (userlogin != null)
          {
              ...
              else
              {
                  ...
                  string returnURL = UrlUtil.GetDomain(Request.Url, ModuleDomain.HR) + "Subscription/PaymentComplete";
                  string cancelURL = UrlUtil.GetDomain(Request.Url, ModuleDomain.HR) + "Home/Index";
      ...
      {                                                 
       ...
       public ActionResult Payment(string pCompanyID = null, string pInvoiceID = null)
       {
           ...
           var strModuleDomain = ModuleDomain.HR;
           if(AppSetting.IsStaging == "true")
           {
               strModuleDomain = ModuleDomain.HR + "-staging";
           }

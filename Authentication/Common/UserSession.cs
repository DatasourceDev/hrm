...
//public class UserSession
//{
//    public static int RIGHT_A = 1;
//    public static int RIGHT_C = 2;
//    public static int RIGHT_U = 3;
//    public static int RIGHT_D = 4;

//    public static bool isSystemRole(HttpContextBase context)
//    {
//        var user = getUser(context);
//        if (user != null && user.User_Authentication.User_Assign_Role != null)
//        {
//            foreach (User_Assign_Role role in user.User_Authentication.User_Assign_Role.ToList())
//            {
//                if (role.User_Role_ID == UserService.ROLE_MAIN_MASTER_ADMIN)
//                {
//                    return true;
//                }
//                else if (role.User_Role_ID == UserService.ROLE_WHITE_LABEL_ADMIN)
//                {
//                    return true;
//                }
//                else if (role.User_Role_ID == UserService.ROLE_FRANCHISE_ADMIN)
//                {
//                    return true;
//                }
//            }
...
//    public static bool havePageRightA(Dictionary<String, List<int>> rights, String page)
//    {
//        if (rights == null)
//        {
//            return false;
...
//    public static bool haveSuscription(List<string> subscription, string name)
//    {
//        if ((from a in subscription where a.Contains(name) select a).FirstOrDefault() != null)
//        {
//            return true;
//        }
//        return false;
...
//                User_Profile profile = userService.getUser(context.User.Identity.GetUserId());
//                context.Session["User"] = profile;
//                if (profile != null && profile.User_Profile_Photo != null)
//                {
//                    context.Session["Profile_Photo"] = profile.User_Profile_Photo.Photo;
//                }
//                userSession = context.Session["User"] as User_Profile;
//            }
//        }
...
//    public static List<string> getSubscription(HttpContextBase context)
//    {
//        var subscription = context.Session["SubScription"] as List<string>;
//        if (subscription == null)
//        {
//            var user = getUser(context);
//            if (user != null)
//            {
//                UserService userService = new UserService();
//                context.Session["SubScription"] = userService.getSubscription(getUser(context).Company_ID.Value);
//                subscription = context.Session["SubScription"] as List<string>;
//            }
...
//            {
//                var companyService = new CompanyService();
//                var company = companyService.GetCompany(user.Company_ID);
//                if (company != null && company.Company_Logo != null && company.Company_Logo.Logo != null)
//                {
//                    context.Session["Company_Logo"] = company.Company_Logo.Logo;
//                    return company.Company_Logo.Logo;
//                }
//            }

...
namespace Time.Models
{
   public class TimeSheetViewModel : ModelBase
   {
      ...
      public string Search_Pending_Date_From { get; set; }
      public string Search_Pending_Date_To { get; set; }
      //Process
      public Nullable<int> Search_Process_Emp { get; set; }
      public string Search_Process_Date_From { get; set; }
      public string Search_Process_Date_To { get; set; }
